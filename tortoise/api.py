...
def download_models(specific_models=None):
    ...
    """
    MODELS = {
        'autoregressive.pth': 'https://huggingface.co/jbetker/tortoise-tts-finetuned-lj/resolve/main/.models/autoregressive.pth',
        'classifier.pth': 'https://huggingface.co/jbetker/tortoise-tts-finetuned-lj/resolve/main/.models/classifier.pth',
        'clvp2.pth': 'https://huggingface.co/jbetker/tortoise-tts-finetuned-lj/resolve/main/.models/clvp2.pth',
        'cvvp.pth': 'https://huggingface.co/jbetker/tortoise-tts-v2/resolve/main/.models/cvvp.pth',
        'diffusion_decoder.pth': 'https://huggingface.co/jbetker/tortoise-tts-finetuned-lj/resolve/main/.models/diffusion_decoder.pth',
        'vocoder.pth': 'https://huggingface.co/jbetker/tortoise-tts-finetuned-lj/resolve/main/.models/vocoder.pth',
        'rlg_auto.pth': 'https://huggingface.co/jbetker/tortoise-tts-finetuned-lj/resolve/main/.models/rlg_auto.pth',
        'rlg_diffuser.pth': 'https://huggingface.co/jbetker/tortoise-tts-finetuned-lj/resolve/main/.models/rlg_diffuser.pth',
    }
